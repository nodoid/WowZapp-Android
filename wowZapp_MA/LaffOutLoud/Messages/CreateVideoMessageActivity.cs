...
{
    public class CreateVideoMessageActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            Header.headertext = Application.Context.Resources.GetString(Resource.String.titleVideo);
            Header.fontsize = 36f;
            ...
            {
                Intent i = new Intent(this, typeof(VideoMessage.VideoMessageActivity));
