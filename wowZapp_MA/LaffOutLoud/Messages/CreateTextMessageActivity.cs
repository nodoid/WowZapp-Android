...
{
	public class CreateTextMessageActivity : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			Header.headertext = Application.Context.Resources.GetString (Resource.String.titleText);
			Header.fontsize = 36f;
			ImageHelper.fontSizeInfo (header.Context);
			header.SetTextSize (Android.Util.ComplexUnitType.Dip, Header.fontsize);
			header.Text = Header.headertext;
			cpcutil.textIsDone = false;
			...
			createAnimation.Click += delegate {
				Intent i = new Intent (this, typeof(CreateTextMessageActivity));
		...
		public override void OnWindowFocusChanged (bool hasFocus)
		{
			...
			if (hasFocus && images != null && !cpcutil.textIsDone) {
